            ...
            <div className="space-y-5">
              ...
              <div className="space-y-1.5">
                ...
                <p className="text-xs text-slate-400">
                  ShipEnter the shipping method name (2-100 characters)
                </p>
              </div>
              ...
              <div className="space-y-3">
                <div>
                  ...
                  <p className="text-xs text-slate-400 mt-0.5">
                    Add different pricing options for this shipping method (minimum 1, maximum 50)
                  </p>
                </div>
                ...
                <div className="space-y-2">
                  <div className="grid grid-cols-2 gap-4 mb-1">
                    ...
                    <Label className="text-xs font-medium text-slate-500">
                      Variation Price <span className="text-red-500">*</span>
                    </Label>
                  </div>
                ...
                <Button
                  type="button"
                  variant="outline"
                  className="w-full border-slate-200 text-slate-600 gap-2 text-sm"
